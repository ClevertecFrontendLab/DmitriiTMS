...
export const MainPage: React.FC = () => {
    ...
    return (
        <div className={styles.mainWrapper}>
            ...
            />
            <Paragraph className={styles.mainText}>CleverFit — это не просто приложение, а твой личный помощник в мире фитнеса. Не откладывай на завтра — начни тренироваться уже сегодня!</Paragraph>
        </div>
    )
};
